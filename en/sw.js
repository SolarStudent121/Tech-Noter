...
self.addEventListener('install', function (event) {
    event.waitUntil(
         caches.open('myapp-static-v1').then(function (cache) {
             return cache.addAll(
                 [
                     { "revision": "22213be8446b561008c7d55aaf532ea6", "url": "bootstrap/bootstrap-icons-1.9.1/bootstrap-icons.css" },
                     ...
                     { "revision": "e7208aebfec0ebd2168a06aca1cf7e49", "url": "https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" },
                     { "revision": "e7208aebfec0ebd2168a06aca1cf7e39", "url": "https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/js/bootstrap.bundle.min.js" },
                     { "revision": "e7208aebfec0ebd2168a06aca1cf7e79", "url": "https://code.jquery.com/jquery-3.6.1.min.js" }
                    ]
             );
         })
    );
